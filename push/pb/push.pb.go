...
type PushOneMsgToUserReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PushOneMsgToUserReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *PushOneMsgToUserReq) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *PushOneMsgToUserReq) GetSeq() int64 {
	if x != nil {
		return x.Seq
	}
	return 0
...
func (x *PushOneMsgToUserReq) GetMsg() string {
	if x != nil {
		return x.Msg
	}
	return ""
...
type PushOneMsgToUserRes struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}
...
func (x *PushOneMsgToUserRes) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
var file_push_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x22, 0x51, 0x0a, 0x13, 0x50, 0x75, 0x73,
	...
	,
...
var file_push_proto_depIdxs = []int32{
	0, // 0: push.gtw.ping:input_type -> push.Empty
	2, // 1: push.gtw.pushOneMsgToUser:input_type -> push.PushOneMsgToUserReq
	1, // 2: push.gtw.ping:output_type -> push.PingResp
	3, // 3: push.gtw.pushOneMsgToUser:output_type -> push.PushOneMsgToUserRes
