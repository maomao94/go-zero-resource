...
type (
	...
	SendOneMsgToUserReq  = pb.SendOneMsgToUserReq
	SendOneMsgToUserResp = pb.SendOneMsgToUserResp
...
func (m *defaultMessage) SendOneMsgToUser(ctx context.Context, in *SendOneMsgToUserReq, opts ...grpc.CallOption) (*SendOneMsgToUserResp, error) {
	client := pb.NewMessageClient(m.cli.Conn())
	return client.SendOneMsgToUser(ctx, in, opts...)
}
